...
public abstract class NewAbstractUsedHardwareCollectorVisitor extends AbstractLanguageCollectorVisitor implements ISensorVisitor<Void>, IAllActorsVisitor<Void> {

    protected final UsedHardwareBean.Builder builder;
    protected final ConfigurationAst robotConfiguration;

    public NewAbstractUsedHardwareCollectorVisitor(UsedHardwareBean.Builder builder, ConfigurationAst configurationAst) {
